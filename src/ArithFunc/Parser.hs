...
happyExpList = Happy_Data_Array.listArray (0,43) ([2048,0,4,0,8,0,512,0,0,4096,4096,0,0,4096,0,512,8192,0,0,256,0,64,96,0,0,352,0,0,128,768,32768,1,192,24576,0,0,0,1,128,0,1,16,5632,49152,0,0,49152,2,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","program","deflistne","def","paramlist","paramlistne","explist","explistne","exp","fun","int","ident","'+'","'-'","','","'*'","'('","')'","'='","'\\n'","%eof"]
...
action_22 (14) = happyShift action_19
...
happyReduction_4 ((HappyAbsSyn11  happy_var_7) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (MkFun happy_var_2 happy_var_4 happy_var_7
	) `HappyStk` happyRest
...
happyReduction_7 (HappyTerminal (L.Ident happy_var_1))
	 =  HappyAbsSyn8
		 ([happy_var_1]
	)
...
happyReduction_8 (HappyTerminal (L.Ident happy_var_3))
	_
...
happyReduction_13 (HappyTerminal (L.Ident happy_var_1))
	 =  HappyAbsSyn11
		 (Var happy_var_1
	)
...
happyReduction_14 (HappyTerminal (L.IntLit happy_var_1))
	 =  HappyAbsSyn11
		 (Lit happy_var_1
	)
...
happyReduction_15 (HappyAbsSyn11  happy_var_3)
	...
	(HappyAbsSyn11  happy_var_1)
	 =  HappyAbsSyn11
		 (Bop happy_var_1 Plus happy_var_3
	)
...
happyReduction_16 (HappyAbsSyn11  happy_var_3)
	...
	(HappyAbsSyn11  happy_var_1)
	 =  HappyAbsSyn11
		 (Bop happy_var_1 Minus happy_var_3
	)
...
happyReduction_17 (HappyAbsSyn11  happy_var_3)
	...
	(HappyAbsSyn11  happy_var_1)
	 =  HappyAbsSyn11
		 (Bop happy_var_1 Times happy_var_3
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	L.Fun -> cont 12;
	L.IntLit happy_dollar_dollar -> cont 13;
	L.Ident happy_dollar_dollar -> cont 14;
	L.Plus -> cont 15;
	L.Minus -> cont 16;
	L.Comma -> cont 17;
	L.Star -> cont 18;
